...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var sumResult = a + ' and ' + b + ' and ' + c + ' sum to ' + totalSum[0] + '.';
  var prodResult = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + totalTime[0] + '.';
  return [totalSum[0], totalTime[0], sumResult, prodResult];
}
...
function sumArray(testArray){ //eslint-disable-line
  ...
  var message = testArray + ' was passed in as an array of numbers, and ' + totalSum[0] + ' is their sum.';
